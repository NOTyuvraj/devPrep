...
export default function Login() {
  ...
  const s = {
    ...
    card: { background: "#1e293b", borderRadius: "12px", padding: "32px", width: "360px", border: "1px solid #334155" },
    title: { color: "#e2e8f0", fontSize: "24px", fontWeight: "bold", marginBottom: "8px" },
    sub: { color: "#94a3b8", fontSize: "14px", marginBottom: "24px" },
    label: { color: "#94a3b8", fontSize: "13px", marginBottom: "6px", display: "block" },
    input: { width: "100%", padding: "10px 12px", background: "#0f172a", border: "1px solid #334155", borderRadius: "8px", color: "#e2e8f0", fontSize: "14px", marginBottom: "16px", boxSizing: "border-box" },
    btn: { width: "100%", padding: "12px", background: "#4f46e5", color: "white", border: "none", borderRadius: "8px", fontSize: "15px", fontWeight: "600", cursor: "pointer", marginBottom: "16px" },
    toggle: { color: "#6366f1", textAlign: "center", fontSize: "13px", cursor: "pointer" },
    error: { background: "#450a0a", color: "#fca5a5", padding: "10px", borderRadius: "8px", fontSize: "13px", marginBottom: "16px" }
  };
